...
namespace SCMAPI.Controllers
{
    ...
    public class LoginController : ApiController
    {
        ...
        [HttpPost]
        [Route("ValidateLoginCreds")]
        public IHttpActionResult validateVendorlogincreds([FromBody] VendorModel model)
        {
            return Ok(this._mprLoginAccess.ValidateLoginCreds(model));
        }
        [HttpGet]
        [Route("checkapi")]
        public string validateVendorlogincreds()
        {
            return "ok";
        }
    }
