...
namespace BALayer.RFQ
{
    public class RFQBA : IRFQBA
    {
        ...
        {
            return _rfqDataAcess.InsertDocumentTOYSCM(model);
        }
       ...
       public  List<VendorRegistrationModel> SaveVendorDetails(VendorRegistrationModel model)
        ...
        public bool sendemailfromvendor(int RFQRevisionId)
        {
           return  this._rfqDataAcess.sendVendormail(RFQRevisionId);
        }
